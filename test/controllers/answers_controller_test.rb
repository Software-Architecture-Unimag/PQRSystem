...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { pqr_id: @answer.pqr_id, user_id: @answer.user_id } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { pqr_id: @answer.pqr_id, user_id: @answer.user_id } }
